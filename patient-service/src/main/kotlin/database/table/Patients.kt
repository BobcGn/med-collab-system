...
object Patients : IdTable<String>("patients") {
    ...
    val gender = varchar("gender", length = 1)
    ...
    val bloodType = varchar("blood_type", length = 16).nullable().default("Unknown")
    val status = varchar("status", length = 16).default("active")
