  ...
  <div class="patient-list-container">
    ...
    <div class="toolbar">
      <div class="actions">
        ...
        <router-link to="/patients" class="btn-primary">管理患者</router-link>
            ...
            <tr v-if="patients.length === 0">
              <td colspan="8" class="empty-state">
                <div class="empty-content">
                  ...
                  <p>暂无患者数据</p>
                  <p v-if="!searchKeyword && !statusFilter"><router-link to="/patients">点击这里</router-link>添加患者</p>
                </div>
              </td>
            </tr>
          </tbody>
...
const editPatient = (patient) => {
  ...
  router.push({
    path: '/patients',
    query: { action: 'edit', id: patient.id }
  })
}
